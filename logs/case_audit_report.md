...
| ID | Domain | source-support | severity | flags |
|----|--------|----------------|----------|-------|
| C-004 | 6 | partial | medium | unrealistic-scenario, incorrect-answer-key, unsupported-claim |
| C-009 | 3 | partial | medium | unsupported-claim, incorrect-answer-key, missing-decision-logic |
| C-010 | 3 | partial | medium | incorrect-answer-key |
